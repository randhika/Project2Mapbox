...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int i = 0;
		testFragmentNames.add(Menu.NONE, i++, Menu.NONE, getString(R.string.navigation)); // Added this for Module 1
	...
	public void submitClicked(View view) {  // #1: Action from clicking the Submit button, this launches UserAddressFragment
		...
		Fragment fragment;
		fragment = new userAddressFragment();
		Bundle args = new Bundle();  				//Passes in the user address to UserAddressFragment
		args.putString("address",str);
	...
	private void selectItem(int position) {
		...
		switch (position) {
			case 0:
				fragment = new NavigationFragment();    ///Creates a new fragment when clicked
				break;
			case 1:
